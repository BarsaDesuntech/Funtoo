...
import { faArrowLeft, faArrowRight, faArrowRightArrowLeft, faBackward, faBalanceScale, faBars, faBookOpen, faCartArrowDown, faClipboardList, faEdit, faHome, faListCheck, faMoneyCheck, faRightFromBracket, faUser } from "@fortawesome/free-solid-svg-icons";
    ...
    <div>
      ...
      <div >
        ...
        <button  style={{borderWidth:0,paddingLeft:20,fontSize:25,color:'white',
          background:'rgb(99, 195, 165)'}} onClick={gotoCart}>
        <FontAwesomeIcon icon={faCartArrowDown} size='25px' />
        </button>
        </div>

        <div style={{marginRight:'1%',color:'white' ,fontSize:25}}>
         <button onClick={accn} style={{borderWidth:0,paddingLeft:20,fontSize:25,color:'white',
          background:'rgb(99, 195, 165)'}}>
